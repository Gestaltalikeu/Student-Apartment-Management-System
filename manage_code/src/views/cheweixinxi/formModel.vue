				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="车位编号" prop="cheweibianhao">
							<el-input class="list_inp" v-model="form.cheweibianhao" :readonly="true" placeholder="车位编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="车位名称" prop="cheweimingcheng">
							<el-input class="list_inp" v-model="form.cheweimingcheng" placeholder="车位名称"
								 type="text" 								:readonly="!isAdd||disabledForm.cheweimingcheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="车位详细" prop="cheweixiangxi">
							<el-input v-model="form.cheweixiangxi" placeholder="车位详细" type="textarea"
							:readonly="!isAdd||disabledForm.cheweixiangxi?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='cheweimingcheng'){
					form.value.cheweimingcheng = row[x];
					disabledForm.value.cheweimingcheng = true;
					continue;
				}
				if(x=='cheweileixing'){
				...
				if(x=='cheweixiangxi'){
					form.value.cheweixiangxi = row[x];
					disabledForm.value.cheweixiangxi = true;
					continue;
				}
			}
			if(row){
			...
			form.value.cheweizhuangtai='未购买'
			formVisible.value = true
		}
		...
		cheweizhuangtaiLists.value = "已购买,未购买".split(',')
	}
	//初始化
	//声明父级调用
	defineExpose({
