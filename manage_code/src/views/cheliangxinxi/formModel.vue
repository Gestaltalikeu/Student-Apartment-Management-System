		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="车辆名称" prop="cheliangmingcheng">
							<el-input class="list_inp" v-model="form.cheliangmingcheng" placeholder="车辆名称"
								 type="text" 								:readonly="!isAdd||disabledForm.cheliangmingcheng?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="车辆类型" prop="cheliangleixing">
							<el-input class="list_inp" v-model="form.cheliangleixing" placeholder="车辆类型"
								 type="text" 								:readonly="!isAdd||disabledForm.cheliangleixing?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="车身颜色" prop="cheshenyanse">
							<el-input class="list_inp" v-model="form.cheshenyanse" placeholder="车身颜色"
								 type="text" 								:readonly="!isAdd||disabledForm.cheshenyanse?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='cheliangmingcheng'){
					form.value.cheliangmingcheng = row[x];
					disabledForm.value.cheliangmingcheng = true;
					continue;
				}
				if(x=='cheliangtupian'){
				...
				if(x=='cheliangleixing'){
					form.value.cheliangleixing = row[x];
					disabledForm.value.cheliangleixing = true;
					continue;
				}
				if(x=='cheshenyanse'){
